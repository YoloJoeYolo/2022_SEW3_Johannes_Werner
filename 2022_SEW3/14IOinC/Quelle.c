...
int main() {
	/*rintf("Geben Sie Ihren Vornamen und Nachnamen ein (max. 50 und 50 Zeichen): ");
	...
	printf("Hallo %s %s, ich w\x81nsche dir einen sch\x94nen Tag!\n", &firstName, &secondName);
	*/
	printf("Geben Sie Ihren Vornamen und Nachnamen ein (max. 100 Zeichen): ");
	char name[101];
